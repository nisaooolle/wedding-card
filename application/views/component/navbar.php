...
*/
    ...
    .btn-primary {
      --bs-btn-color: #fff;
      --bs-btn-bg: #F1B4BB;
      --bs-btn-border-color: #F1B4BB;
      --bs-btn-hover-color: #fff;
      --bs-btn-hover-bg: #ff9a9c;
      --bs-btn-hover-border-color: #ff9a9c;
      --bs-btn-focus-shadow-rgb: 255, 208, 38;
      --bs-btn-active-color: #fff;
      --bs-btn-active-bg: #ff9a9c;
      --bs-btn-active-border-color: #ff9a9c;
      --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
      --bs-btn-disabled-color: #fff;
      --bs-btn-disabled-bg: #F1B4BB;
      --bs-btn-disabled-border-color: #F1B4BB;
    }
    ...
    .btn-dark {
      ...
      --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
      --bs-btn-disabled-color: #fff;
      --bs-btn-disabled-bg: #ff9a9c;
      --bs-btn-disabled-border-color: #ff9a9c;
    }
    ...
    .btn-outline-primary {
      ...
      --bs-btn-border-color: #F1B4BB;
      --bs-btn-hover-color: #fff;
      --bs-btn-hover-bg: #F1B4BB;
      --bs-btn-hover-border-color: #F1B4BB;
      --bs-btn-focus-shadow-rgb: 255, 200, 0;
      --bs-btn-active-color: #fff;
      --bs-btn-active-bg: #F1B4BB;
      --bs-btn-active-border-color: #F1B4BB;
      --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
      --bs-btn-disabled-color: #F1B4BB;
    ...
    .dropdown-menu {
      ...
      --bs-dropdown-link-color: #ff9a9c;
      --bs-dropdown-link-hover-color: #1e2125;
      --bs-dropdown-link-hover-bg: #e9ecef;
      --bs-dropdown-link-active-color: #fff;
      --bs-dropdown-link-active-bg: #F1B4BB;
    ...
    .nav-pills {
      ...
      --bs-nav-pills-link-active-bg: #F1B4BB;
    }
    ...
    .pagination {
      ...
      --bs-pagination-active-bg: #F1B4BB;
      --bs-pagination-active-border-color: #F1B4BB;
    ...
    .list-group {
      ...
      --bs-list-group-action-active-color: #ff9a9c;
      --bs-list-group-action-active-bg: #e9ecef;
      --bs-list-group-disabled-color: #6c757d;
      --bs-list-group-disabled-bg: #fff;
      --bs-list-group-active-color: #fff;
      --bs-list-group-active-bg: #F1B4BB;
      --bs-list-group-active-border-color: #F1B4BB;
      display: flex;
      flex-direction: column;
      padding-left: 0;
      margin-bottom: 0;
  ...
  "stringMap":[ {
    ...
    header.masthead {
      ...
      text-align: center;
      color: #fff;
      background-image: url("https://www.balipixtura.com/wp-content/uploads/2022/06/labuan-bajo-prewedding-bali-pixtura-11(pp_w768_h511).jpg");
      background-repeat: no-repeat;
...
<nav class="navbar navbar-expand-lg fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="#page-top"><img src="https://our-wedding.link/_ipx/f_webp/assets/images/Monogram.svg" alt="..." /></a>
